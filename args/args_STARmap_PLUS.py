...
def generate_args():
    ...
    parser.add_argument('--AD_adata_path', default='/home1/shezixi/data/in_silico_central_dogma_challenge/unprocessed/2023_nn_AD_mouse/AD_model_adata_protein', type=str)
    parser.add_argument('--Wild_type_adata_path', default='/home1/shezixi/data/in_silico_central_dogma_challenge/unprocessed/2023_nn_AD_mouse/wild_type_adata_protein', type=str)
